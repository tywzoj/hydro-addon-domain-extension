...
export const enum CE_String {
    CONFIG_NAME = "Discussion Node",
    CONFIG_DESC = "Set the discussion node for the domain, leave empty to use the global setting. After modification, click the 'Init Discussion Node' button in the 'Dashboard' tab to apply the settings.",
}
